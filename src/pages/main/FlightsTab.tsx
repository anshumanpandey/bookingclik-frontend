...
export const FlightsTab: React.FC = () => {
    ...
    return (
        ...
        <section className="scroll-con-sec hero-section" style={{ paddingTop: '100px', height: '80vh' }} data-scrollax-parent="true" id="sec1">
            <div className="bg"  data-bg="images/bg/flight.jpg" data-scrollax="properties: { translateY: '200px' }"></div>
            ...
            <div className="hero-section-wrap fl-wrap">
                ...
                <div className="container">
                    <div className="intro-item fl-wrap">
                        <h2 style={{ textAlign: 'left', width: '90%',float: 'right'}}>Where to next?</h2>
                    </div>
